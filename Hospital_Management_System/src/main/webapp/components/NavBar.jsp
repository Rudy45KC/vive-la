<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
	...
	<i class="fa-solid fa-hands-holding-child" style="padding:2rem"></i>
		 <a class="navbar-brand" href="index.jsp">Vive la</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link active" href="User_Login.jsp">Patient
						Login</a></li>
				<li class="nav-item"><a class="nav-link active" href="Doctor_Login.jsp">Doctor
						Login</a></li>
